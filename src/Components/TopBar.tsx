	...
	return (
		<div className="bg-gray-700 flex flex-col">
			<div className="p-2 flex flex-row flex-wrap">
				<div className="p-2 flex flex-row flex-wrap flex-grow justify-between">
					<div className="flex flex-col justify-center mr-1">
						<span className="text-white text-xl font-bold">SimpleHe3</span>
					</div>

					<div className="flex flex-row self-center justify-center mx-1">
						<span className="text-white text-sm">{ual?.activeUser?.accountName}</span>
					</div>
				</div>

				<div className="flex flex-row flex-wrap justify-between flex-grow md:flex-grow-0">
