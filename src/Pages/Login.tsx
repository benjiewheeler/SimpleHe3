		...
		<>
			<div className="flex flex-col flex-grow h-full w-full p-4 text-center">
				...
				<div className="flex flex-col mt-6 text-gray-400 border self-center p-4 rounded-xl border-slate-700 max-w-lg">
					...
					<p className="text-sm my-2">
						This website is developed by <span className="font-bold text-indigo-500">Benjie#5458</span> for personal use (on
						mobile), and is not affiliated with Moon Mining He3
					</p>
					...
					<p className="text-sm my-2">
						...
						<a className="font-bold" target="_blank" rel="nofollow" href="https://github.com/benjiewheeler/SimpleHe3">
							Github &#8599;
						</a>
					</p>
					<p className="text-sm my-2">Happy Mining</p>
				</div>
			</div>
		</>
	);
